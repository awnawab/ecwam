...
# optimization and vectorization flags must be per-sourcefile overrideable, so are set via ${PNAME}_Fortran_FLAGS
if( DEFINED optimization_flags )
  ecbuild_add_fortran_flags( "${optimization_flags}"   NAME optimization BUILD BIT PROJECT )
endif()
if( DEFINED vectorization_flags )
  ecbuild_add_fortran_flags( "${vectorization_flags}"   NAME vectorization BUILD BIT PROJECT )
endif()
...
if( CMAKE_BUILD_TYPE MATCHES "Debug" )
  ...
  if(CMAKE_Fortran_COMPILER_ID MATCHES "Intel")
    ...
    ecbuild_add_fortran_flags( "-check noarg_temp_created" NAME noarg_temp BUILD DEBUG PROJECT )
  endif()
endif()
