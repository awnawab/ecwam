...
!
      ...
      SUBROUTINE SNONLIN (KIJS, KIJL, FL1, FLD, SL, WAVNUM, DEPTH, AKMEAN, ENH)
...
#include "transf_snl.intfb.h"
      ...
      REAL(KIND=JWRB), DIMENSION(KIJL), INTENT(IN) :: AKMEAN
      REAL(KIND=JWRB), DIMENSION(KIJL,MLSTHG), INTENT(INOUT) :: ENH
