...
!       CONVERT DIRECTIONS TO DEGREES AND METEOROLOGICAL CONVENTION
        DO IJ=KIJS,KIJL
          BOUT(IJ,ITG)=DEG*BOUT(IJ,ITG)+180._JWRB-INT((DEG*BOUT(IJ,ITG)+180._JWRB)/360._JWRB)*360._JWRB
        ENDDO
      ENDIF
...
!       CONVERT DIRECTIONS TO DEGREES AND METEOROLOGICAL CONVENTION
        DO IJ=KIJS,KIJL
          BOUT(IJ,ITOBOUT(5))=DEG*WDWAVE(IJ)+180._JWRB-INT((DEG*WDWAVE(IJ)+180._JWRB)/360._JWRB)*360._JWRB
        ENDDO
      ENDIF
...
!       CONVERT DIRECTIONS TO DEGREES AND METEOROLOGICAL CONVENTION
        DO IJ=KIJS,KIJL
          BOUT(IJ,ITOBOUT(13))=DEG*THWISEA(IJ)+180._JWRB-INT((DEG*THWISEA(IJ)+180._JWRB)/360._JWRB)*360._JWRB
        ENDDO
      ENDIF
...
!       CONVERT DIRECTIONS TO DEGREES AND METEOROLOGICAL CONVENTION
        DO IJ=KIJS,KIJL
          BOUT(IJ,ITOBOUT(14))=DEG*THSWELL(IJ)+180._JWRB-INT((DEG*THSWELL(IJ)+180._JWRB)/360._JWRB)*360._JWRB
        ENDDO
      ENDIF
...
!     SURFACE STOKES DRIFT U and V
      ...
      DO ITR=1,NTRAIN
        ...
        IF (IPFGTBL(43 + (ITR-1)*3) /= 0) THEN
          DO IJ=KIJS,KIJL
            BOUT(IJ,ITOBOUT(43 + (ITR-1)*3))=DEG*THTRAIN(IJ,ITR)+180._JWRB-INT((DEG*THTRAIN(IJ,ITR)+180._JWRB)/360._JWRB)*360._JWRB
          ENDDO
        ENDIF
...
!       CONVERT DIRECTIONS TO DEGREES AND METEOROLOGICAL CONVENTION
        DO IJ = KIJS,KIJL
          BOUT(IJ,ITOBOUT(54 + 3*NTRAIN))=DEG*FLD2(IJ)+180._JWRB-INT((DEG*FLD2(IJ)+180._JWRB)/360._JWRB)*360._JWRB
        ENDDO
      ENDIF
