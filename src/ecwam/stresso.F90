...
! ----------------------------------------------------------------------
      ...
      REAL(KIND=JWRB), DIMENSION(KIJL,NANG,NFRE), INTENT(IN) :: SL, SPOS
      REAL(KIND=JWRB), DIMENSION(KIJL,NFRE), INTENT(IN) :: CINV
      REAL(KIND=JWRB), DIMENSION(KIJL), INTENT(IN) :: WDWAVE, UFRIC, Z0M, AIRD
      REAL(KIND=JWRB), DIMENSION(KIJL), INTENT(IN) :: RNFAC
      REAL(KIND=JWRB), DIMENSION(KIJL, NANG), INTENT(IN) :: COSWDIF, SINWDIF2
      REAL(KIND=JWRB), DIMENSION(KIJL), INTENT(OUT) :: TAUW, TAUWDIR
      REAL(KIND=JWRB), DIMENSION(KIJL), INTENT(OUT) :: PHIWA
      LOGICAL, INTENT(IN) :: LLPHIWA


      INTEGER(KIND=JWIM) :: IJ, M, K, I, J
      ...
      REAL(KIND=JWRB), DIMENSION(KIJL) :: USDIRP
      REAL(KIND=JWRB), DIMENSION(KIJL) :: UST
