...
INTEGER(KIND=JWIM) FUNCTION IWAM_GET_UNIT (KUSO, CDNAME, CDACCESS, CDFORM, KRECL, CDACTION, LSTREAM)
...
!--------------------------------------------------------------------
      ...
      LOGICAL, OPTIONAL, INTENT(IN) :: LSTREAM
