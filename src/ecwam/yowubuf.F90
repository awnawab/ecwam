...
!*    ** *UBUF*  GRID POINT DEPENDENT CONSTANTS
      ...
      REAL(KIND=JWRB), ALLOCATABLE, TARGET :: OBSLAT(:,:,:) 
      REAL(KIND=JWRB), ALLOCATABLE, TARGET :: OBSLON(:,:,:) 
      REAL(KIND=JWRB), ALLOCATABLE, TARGET :: OBSCOR(:,:,:) 
      REAL(KIND=JWRB), ALLOCATABLE, TARGET :: OBSRLAT(:,:,:) 
      REAL(KIND=JWRB), ALLOCATABLE, TARGET :: OBSRLON(:,:,:) 
